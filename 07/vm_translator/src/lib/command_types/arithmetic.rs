...
impl CommandTypeBuilder for ArithmeticCommand {
    ...
    fn is_a(line: &String) -> bool {
        ...
        line.starts_with("eq") || line.starts_with("gt") || line.starts_with("lt") ||
        line.starts_with("not") || line.starts_with("or") || line.starts_with("and")
    }
}
...
impl CommandType for ArithmeticCommand {
    fn to_asm(&self, index: usize) -> String {
        match self.line.as_str() {
            ...
            "eq" => ArithmeticCommand::eq(index),
            "gt" => ArithmeticCommand::gt(index),
            "lt" => ArithmeticCommand::lt(index),
